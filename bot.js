...
client.on('ready', () => {
  client.user.setGame(` By GeRaLd .`,'https://www.twitch.tv/v5bz');
  console.log('---------------');
...
if (message.content === '*help') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)    
      .addField("** مبرمج البوت :wrench: **","**@!     GeRaLdᴰᵉᵛ  **")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`GERALD Bot- Script By : GERALD`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : GERALD ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(` ON ${client.guilds.size} Servers - Prefix *help + by GERALD`,"http://twitch.tv/S-F")
...
client.login("Mzk2MjAyNDExOTU1MzIyODkw.DSd_xA.anMzEi2wunlQtxDw1_i1COxb0gg");
